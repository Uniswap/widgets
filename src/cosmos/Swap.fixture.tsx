...
function Fixture() {
  ...
  return (
    <SwapWidget
      ...
      onTxSubmit={(txHash: string, data: any) => console.log('tx submitted:', txHash)}
      onTxSuccess={(txHash: string, data: any) => console.log('tx success:', txHash)}
      onTxFail={(error: Error, data: any) => console.log('tx fail:', error)}
    />
  )
}
