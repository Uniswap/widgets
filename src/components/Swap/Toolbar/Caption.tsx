...
const Expander = ({ expanded, toggleOpen }: ExpandProps) => {
  return <ExpandIcon $expanded={expanded} onClick={toggleOpen} />
}
  ...
  return (
    <>
      ...
      <CaptionRow gap={0.75}>
        ...
        <Expander expanded={expanded} toggleOpen={toggleOpen} />
      </CaptionRow>
    </>
  )
}
...
export function PriceImpact({ impact, expanded, toggleOpen }: PriceImpactProps & ExpandProps) {
  return (
    <>
      <Caption
        icon={AlertTriangle}
