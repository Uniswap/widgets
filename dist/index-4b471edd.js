import React, { Children, useMemo, createContext, useContext, useRef, memo, forwardRef, useState, useCallback, useEffect, useImperativeHandle, StrictMode } from 'react';
...
import { _TypedDataEncoder, namehash as namehash$1 } from '@ethersproject/hash';
...
function Trans$1(props) {
  ...
  var values = _objectSpread$l({}, props.values);

  var components = _objectSpread$l({}, props.components);
...
process.env.NODE_ENV === "production" ? i$1 : I18nProvider;
...
var BnbChainNativeCurrency = /*#__PURE__*/function (_NativeCurrency) {
  ...
  var _super = _createSuper$5(BnbChainNativeCurrency);
...
var MaticNativeCurrency = /*#__PURE__*/function (_NativeCurrency2) {
  ...
  var _super2 = _createSuper$5(MaticNativeCurrency);
...
var ExtendedEther = /*#__PURE__*/function (_Ether) {
  ...
  var _super3 = _createSuper$5(ExtendedEther);
...
function processTokens(tokens) {
  ...
  return tokens.map(function (token) {
    ...
    return [token.arg, token.type, _objectSpread$g({
      offset: offset
    }, formatProps)];
  });
...
var WidgetError = /*#__PURE__*/function (_Error) {
  ...
  var _super = _createSuper$2(WidgetError);
...
var UnknownError = /*#__PURE__*/function (_WidgetError) {
  ...
  var _super2 = _createSuper$2(UnknownError);
...
var WidgetPromise = /*#__PURE__*/function (_Promise) {
  ...
  var _super3 = _createSuper$2(WidgetPromise);
...
var IntegrationError = /*#__PURE__*/function (_WidgetError2) {
  ...
  var _super4 = _createSuper$2(IntegrationError);
...
var DismissableError = /*#__PURE__*/function (_WidgetError3) {
  ...
  var _super5 = _createSuper$2(DismissableError);
  ...
  function DismissableError(config) {
    ...
    _this4 = _super5.call(this, _objectSpread$f(_objectSpread$f({}, config), {}, {
...
var UserRejectedRequestError = /*#__PURE__*/function (_DismissableError) {
  ...
  var _super6 = _createSuper$2(UserRejectedRequestError);
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 2:
                    ...
                    args.routerPreference === RouterPreference.API && Boolean(args.routerUrl) && // A null amount may be passed to initialize the client-side routing.
                    args.amount !== null)) {
                      _context2.next = 28;
                      break;
                    }
                    ...
                    query = qs.stringify(_objectSpread$e(_objectSpread$e({}, DEFAULT_QUERY_PARAMS), {}, {
                  ...
                  case 28:
                    _context2.next = 30;
                    return import('./clientSideSmartOrderRouter-d6fd8ee8.js');
...
(_RETRY_OPTIONS_BY_CHA = {}, _defineProperty(_RETRY_OPTIONS_BY_CHA, SupportedChainId.ARBITRUM_ONE, {
  n: 10,
  minWait: 250,
  maxWait: 1000
...
function getWalletConnectMeta(provider) {
  ...
  if ('session' in provider) {
    ...
    metadata = (_provider$session = provider.session) === null || _provider$session === void 0 ? void 0 : _provider$session.peer.metadata;
  } else {
...
function getInjectedMeta(provider) {
  ...
  var names = (_properties$filter$ma = properties.filter(function (name) {
    ...
    return name.slice(2);
  })) !== null && _properties$filter$ma !== void 0 ? _properties$filter$ma : []; // Many wallets spoof MetaMask by setting `isMetaMask` along with their own identifier,
  ...
  return {
    ...
    agent: [].concat(_toConsumableArray(names), ['(Injected)']).join(' '),
    name: names[0] // TODO(WEB-2914): Populate description, url, and icons for known wallets.
...
var WC_PEERS_LACKING_V4_SUPPORT = ['SafePal Wallet', 'Ledger Wallet Connect']; // Assumes v4 support by default, except for known wallets.
...
function _signTypedData() {
  _signTypedData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(signer, domain, types, // Use Record<string, any> for the value to match the JsonRpcSigner._signTypedData signature.
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 14:
            ...
            if (!(typeof _context.t0.message === 'string' && _context.t0.message.match(/not (found|implemented)/i))) {
              _context.next = 22;
              break;
            }
...
var ONE_HUNDRED_PERCENT = new Percent('1'); // gas margin to ensure successful transactions
...
var fiatTokenPricesFormatter = [{
  ...
  upperBound: 0.1,
  formatter: THREE_SIG_FIGS_USD
}, // Round to 3 significant figures, show significant trailing zeros
{
  upperBound: 1.05,
  formatter: THREE_DECIMALS_USD
}, // Round to 3 decimal places, show significant trailing zeros
{
  upperBound: 1000000,
  formatter: TWO_DECIMALS_USD
...
var TYPE_TO_FORMATTER_RULES = (_TYPE_TO_FORMATTER_RU = {}, _defineProperty(_TYPE_TO_FORMATTER_RU, NumberType.TokenNonTx, tokenNonTxFormatter), _defineProperty(_TYPE_TO_FORMATTER_RU, NumberType.TokenTx, tokenTxFormatter), _defineProperty(_TYPE_TO_FORMATTER_RU, NumberType.SwapTradeAmount, swapTradeAmountFormatter), _defineProperty(_TYPE_TO_FORMATTER_RU, NumberType.FiatTokenQuantity, fiatTokenQuantityFormatter), _defineProperty(_TYPE_TO_FORMATTER_RU, NumberType.FiatTokenDetails, fiatTokenDetailsFormatter), _defineProperty(_TYPE_TO_FORMATTER_RU, NumberType.FiatTokenPrice, fiatTokenPricesFormatter), _defineProperty(_TYPE_TO_FORMATTER_RU, NumberType.FiatTokenStats, fiatTokenStatsFormatter), _defineProperty(_TYPE_TO_FORMATTER_RU, NumberType.FiatGasPrice, fiatGasPriceFormatter), _defineProperty(_TYPE_TO_FORMATTER_RU, NumberType.PortfolioBalance, portfolioBalanceFormatter), _defineProperty(_TYPE_TO_FORMATTER_RU, NumberType.NFTTokenFloorPrice, ntfTokenFloorPriceFormatter), _defineProperty(_TYPE_TO_FORMATTER_RU, NumberType.NFTTokenFloorPriceTrailingZeros, ntfTokenFloorPriceFormatterTrailingZeros), _defineProperty(_TYPE_TO_FORMATTER_RU, NumberType.NFTCollectionStats, ntfCollectionStatsFormatter), _TYPE_TO_FORMATTER_RU);
...
function formatNumber(input) {
  var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : NumberType.TokenNonTx;
...
function formatCurrencyAmount$1(amount) {
  var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : NumberType.TokenNonTx;
  var placeholder = arguments.length > 2 ? arguments[2] : undefined;
...
function formatPrice(price) {
  var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : NumberType.FiatTokenPrice;
...
function Popover(_ref6) {
  ...
  var options = useMemo(function () {
    ...
    if (contained) {
      modifiers.push({
      ...
      }, _objectSpread$a(_objectSpread$a({}, maxSize), {}, {
        options: {
          boundary: boundary,
          padding: 8
        }
        ...
        fn: function fn(_ref7) {
          ...
          state.styles.popper = _objectSpread$a(_objectSpread$a({}, state.styles.popper), {}, {
...
var CoingeckoSrc = /*#__PURE__*/function (_UriSrc) {
  ...
  var _super = _createSuper$1(CoingeckoSrc);
...
function Logo(_ref9) {
  ...
  var imageProps = _objectSpread$9({
    ...
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            validatorImport = import('./validateTokenList-42ae876b.js');
            return _context.abrupt("break", 9);

          case 5:
            validatorImport = import('./validateTokens-bc6da707.js');
            return _context.abrupt("break", 9);
...
function Dialog(_ref19) {
  ...
  return mountPoint && /*#__PURE__*/createPortal( /*#__PURE__*/React.createElement(Provider$2, null, /*#__PURE__*/React.createElement(PopoverBoundaryProvider, {
...
function Details(_ref7) {
  ...
  var _useMemo = useMemo(function () {
    ...
    if (gasUseEstimateUSD) {
      details.push([
      /*i18n*/
      i18n._("Network fee"), "~".concat(formatCurrencyAmount$1(gasUseEstimateUSD, NumberType.FiatGasPrice))]);
    }

    if (impact) {
      details.push([
      /*i18n*/
      i18n._("Price impact"), impact !== null && impact !== void 0 && impact.percent ? formatPriceImpact(impact === null || impact === void 0 ? void 0 : impact.percent) : '-', impact.warning]);
    }
...
var WalletConnectQR = /*#__PURE__*/function (_WalletConnect2) {
  ...
  var _super2 = _createSuper(WalletConnectQR);
...
function isUniswapWallet(provider) {
  ...
  return ((_getWalletMeta = getWalletMeta(provider)) === null || _getWalletMeta === void 0 ? void 0 : _getWalletMeta.name) === 'Uniswap Wallet';
}
/**
...
function _sendTransaction() {
  _sendTransaction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(provider, transaction) {
    var gasMargin,
        skipGasLimit,
        signer,
        gasLimit,
    ...
    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            gasMargin = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : 0;
            skipGasLimit = _args2.length > 3 && _args2[3] !== undefined ? _args2[3] : isUniswapWallet(provider);
          ...
          case 8:
            _context2.next = 10;
            return signer.sendUncheckedTransaction(_objectSpread$2(_objectSpread$2({}, transaction), {}, {
              gasLimit: gasLimit
            }));
          ...
          case 10:
            ...
            _context2.prev = 11;
            _context2.next = 14;
            return poll( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
              var tx;
              return _regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 5:
                      return _context.abrupt("return", provider._wrapTransaction(tx, hash));
          ...
          case 17:
            ...
            _context2.t0.transactionHash = hash;
            throw _context2.t0;
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 5:
                      ...
                      invariant(trade); // onSubmit expects the TransactionInfo to be returned if the transaction was submitted.
...
var JSON_RPC_FALLBACK_ENDPOINTS = (_JSON_RPC_FALLBACK_EN = {}, _defineProperty(_JSON_RPC_FALLBACK_EN, SupportedChainId.MAINNET, [// "Safe" URLs
'https://cloudflare-eth.com', // "Fallback" URLs
'https://rpc.ankr.com/eth', 'https://eth-mainnet.public.blastapi.io']), _defineProperty(_JSON_RPC_FALLBACK_EN, SupportedChainId.ROPSTEN, [// "Fallback" URLs
'https://rpc.ankr.com/eth_ropsten']), _defineProperty(_JSON_RPC_FALLBACK_EN, SupportedChainId.RINKEBY, [// "Fallback" URLs
'https://rinkeby-light.eth.linkpool.io/']), _defineProperty(_JSON_RPC_FALLBACK_EN, SupportedChainId.GOERLI, [// "Safe" URLs
'https://rpc.goerli.mudit.blog/', // "Fallback" URLs
'https://rpc.ankr.com/eth_goerli']), _defineProperty(_JSON_RPC_FALLBACK_EN, SupportedChainId.KOVAN, [// "Fallback" URLs
'https://eth-kovan.public.blastapi.io']), _defineProperty(_JSON_RPC_FALLBACK_EN, SupportedChainId.POLYGON, [// "Safe" URLs
'https://polygon-rpc.com/']), _defineProperty(_JSON_RPC_FALLBACK_EN, SupportedChainId.POLYGON_MUMBAI, [// "Safe" URLs
'https://matic-mumbai.chainstacklabs.com', 'https://rpc-mumbai.maticvigil.com', 'https://matic-testnet-archive-rpc.bwarelabs.com']), _defineProperty(_JSON_RPC_FALLBACK_EN, SupportedChainId.ARBITRUM_ONE, [// "Safe" URLs
'https://arb1.arbitrum.io/rpc', // "Fallback" URLs
'https://arbitrum.public-rpc.com']), _defineProperty(_JSON_RPC_FALLBACK_EN, SupportedChainId.ARBITRUM_RINKEBY, [// "Safe" URLs
'https://rinkeby.arbitrum.io/rpc']), _defineProperty(_JSON_RPC_FALLBACK_EN, SupportedChainId.OPTIMISM, [// "Safe" URLs
'https://mainnet.optimism.io/', // "Fallback" URLs
'https://rpc.ankr.com/optimism']), _defineProperty(_JSON_RPC_FALLBACK_EN, SupportedChainId.OPTIMISM_GOERLI, [// "Safe" URLs
'https://goerli.optimism.io']), _defineProperty(_JSON_RPC_FALLBACK_EN, SupportedChainId.CELO, [// "Safe" URLs
'https://forno.celo.org']), _defineProperty(_JSON_RPC_FALLBACK_EN, SupportedChainId.CELO_ALFAJORES, [// "Safe" URLs
'https://alfajores-forno.celo-testnet.org']), _defineProperty(_JSON_RPC_FALLBACK_EN, SupportedChainId.BNB, [// "Safe" URLs
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            _context2.prev = 5;
            _context2.next = 8;
            return provider.send('wallet_addEthereumChain', [_objectSpread(_objectSpread({}, addChainParameter), {}, {
              rpcUrls: [rpcUrl]
            })]);
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              addChainParameter = {
                ...
                nativeCurrency: _objectSpread(_objectSpread({}, nativeCurrency), {}, {
  ...
  var tradeSummaryRows = useMemo(function () {
    ...
    var rows = [{
      ...
      nameTooltip: {
        content:
        /*i18n*/
        i18n._("The fee paid to miners to process your transaction. This must be paid in ETH.")
      },
      ...
      nameTooltip: {
        content:
        /*i18n*/
        i18n._("The impact your trade has on the market price of this pool.")
      },
      ...
      name:
      /*i18n*/
      i18n._("Expected output"),
      value: trade ? "".concat(formatCurrencyAmount$1(trade === null || trade === void 0 ? void 0 : trade.outputAmount), " ").concat(currencySymbol) : '-',
      nameTooltip: trade ? {
        content:
        /*i18n*/
        i18n._("The amount you expect to receive at the current market price. You may receive less or more if the market price changes while your transaction is pending.")
      } : undefined
    }];
    return rows;
...
var Toolbar$1 = /*#__PURE__*/memo(function WrappedToolbar() {
  return /*#__PURE__*/React.createElement(Provider, null, /*#__PURE__*/React.createElement(Toolbar, null));
});
...
function SwapWidgetSkeleton(_ref7) {
  var theme = _ref7.theme,
      width = _ref7.width;
  return /*#__PURE__*/React.createElement(StrictMode, null, /*#__PURE__*/React.createElement(Provider$2, {
    theme: theme
...
function SwapWidget(props) {
  return /*#__PURE__*/React.createElement(Swap, props);
}
