import React, { useContext, createContext, useMemo, useEffect, useState, useCallback, useRef, forwardRef, Children, useImperativeHandle, memo, Component, StrictMode } from 'react';
import _slicedToArray from '@babel/runtime/helpers/slicedToArray';
import _defineProperty from '@babel/runtime/helpers/defineProperty';
import { Token, WETH9, NativeCurrency, Ether, CurrencyAmount, Percent, TradeType, Price as Price$1, Fraction } from '@uniswap/sdk-core';
...
import { FACTORY_ADDRESS, Pair, computePairAddress, Trade as Trade$1, Route as Route$2 } from '@uniswap/v2-sdk';
import { FACTORY_ADDRESS as FACTORY_ADDRESS$1, computePoolAddress, Pool as Pool$1, FeeAmount, Route as Route$1, SwapQuoter } from '@uniswap/v3-sdk';
...
import { Trade as Trade$2, Protocol } from '@uniswap/router-sdk';
...
import _extends$8 from '@babel/runtime/helpers/extends';
    ...
    try {
      for (y.s(); !(v = y.n()).done;) {
        var h = _slicedToArray(v.value, 3),
            ...
            O = h[2],
            j = o[b];
        (!j || s$1[j.type] && g) && (j ? console.error("".concat(j.type, " is a void element tag therefore it must have no children")) : console.error("Can use element at index '".concat(b, "' as it is not declared in the original translation")), j = /*#__PURE__*/React.createElement(React.Fragment)), u.push( /*#__PURE__*/React.cloneElement(j, {
          key: a()
...
_objectSpread$8(_objectSpread$8({}, WRAPPED_NATIVE_CURRENCIES_ONLY), {}, _defineProperty({}, SupportedChainId.MAINNET, [].concat(_toConsumableArray(WRAPPED_NATIVE_CURRENCIES_ONLY[SupportedChainId.MAINNET]), [DAI, USDC_MAINNET, USDT, WBTC])));
    ...
    if (amountSpecified && currencyIn && currencyOut && allowedPairs.length > 0) {
      if (maxHops === 1) {
        ...
        if (tradeType === TradeType.EXACT_INPUT) {
          ...
          return (_Trade$bestTradeExact = Trade$1.bestTradeExactIn(allowedPairs, amountIn, currencyOut, options)[0]) !== null && _Trade$bestTradeExact !== void 0 ? _Trade$bestTradeExact : null;
        } else {
          var _Trade$bestTradeExact2;

          var amountOut = amountSpecified;
          return (_Trade$bestTradeExact2 = Trade$1.bestTradeExactOut(allowedPairs, currencyIn, amountOut, options)[0]) !== null && _Trade$bestTradeExact2 !== void 0 ? _Trade$bestTradeExact2 : null;
        }
      ...
      for (var i = 1; i <= maxHops; i++) {
        ...
        if (tradeType === TradeType.EXACT_INPUT) {
          ...
          currentTrade = (_Trade$bestTradeExact3 = Trade$1.bestTradeExactIn(allowedPairs, _amountIn, currencyOut, _options)[0]) !== null && _Trade$bestTradeExact3 !== void 0 ? _Trade$bestTradeExact3 : null;
        } else {
          var _Trade$bestTradeExact4;

          var _amountOut = amountSpecified;
          currentTrade = (_Trade$bestTradeExact4 = Trade$1.bestTradeExactOut(allowedPairs, currencyIn, _amountOut, _options)[0]) !== null && _Trade$bestTradeExact4 !== void 0 ? _Trade$bestTradeExact4 : null;
...
var loadingCss = /*#__PURE__*/css(["filter:grayscale(1);opacity:", ";"], loadingOpacity); // need to use isLoading as `loading` is a reserved prop

var loadingTransitionCss = /*#__PURE__*/css(["opacity:", ";transition:color 0.125s linear,opacity ", "s ease-in-out;"], function (_ref) {
...
var Logo = /*#__PURE__*/_styled(icon(SvgLogo)).withConfig({
...
var InlineSpinner = /*#__PURE__*/_styled(icon(SvgInlineSpinner)).withConfig({
...
function H2(props) {
  return /*#__PURE__*/React.createElement(TextWrapper, _extends$8({
...
function TransitionButton(props) {
  ...
  return /*#__PURE__*/React.createElement(TransitionTextWrapper, _extends$8({
    className: className,
    fontSize: fontSize,
    fontWeight: 500,
...
var IconButton = /*#__PURE__*/forwardRef(function IconButton(_ref7, ref) {
  ...
  return /*#__PURE__*/React.createElement(SecondaryButton, _extends$8({}, props, {
    ref: ref
...
function Header$2(_ref) {
  ...
  return /*#__PURE__*/React.createElement(HeaderRow, {
    ...
    gap: 0.5
  }, title && /*#__PURE__*/React.createElement(Subhead1, null, title)), /*#__PURE__*/React.createElement(Row, {
    gap: 1
  }, children));
}
...
function Header$1(_ref2) {
  var title = _ref2.title,
      ...
      ruled = _ref2.ruled;
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Column, null, /*#__PURE__*/React.createElement(Header$2, {
    title: title
  }, children, /*#__PURE__*/React.createElement(IconButton, {
    color: "primary",
    onClick: useContext(OnCloseContext),
    icon: X
  })), ruled && /*#__PURE__*/React.createElement(Rule, {
    padded: true
  })));
}
...
function Popover(_ref5) {
  ...
  var options = useMemo(function () {
    ...
    if (contained) {
      ...
      }, _objectSpread$1(_objectSpread$1({}, maxSize), {}, {
        options: {
          boundary: boundary,
          padding: 8
        }
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Reference, {
    ref: reference
  }, children), boundary && /*#__PURE__*/createPortal( /*#__PURE__*/React.createElement(PopoverContainer, _extends$8({
    show: show,
    ref: setPopover,
    style: styles.popper
  }, attributes.popper), content, /*#__PURE__*/React.createElement(Arrow, _extends$8({
...
var WalletButton = /*#__PURE__*/_styled(TextButton).withConfig({
...
function Wallet(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(WalletButton, {
    onClick: onClick,
    color: "secondary",
    disabled: !onClick,
    hidden: disabled,
    "data-testid": "wallet"
  }, /*#__PURE__*/React.createElement(Caption$1, null, /*#__PURE__*/React.createElement(Row, {
    gap: 0.5
  }, /*#__PURE__*/React.createElement(Wallet$1, null), /*#__PURE__*/React.createElement(Trans, {
...
var MissingTokenImg = /*#__PURE__*/_styled.img.withConfig({
...
function TokenImg(_ref) {
  ...
  if (!src) return /*#__PURE__*/React.createElement(MissingTokenImg, _extends$8({
    src: missingTokenSrc,
    alt: alt,
    color: "secondary"
  }, rest));
...
var Input$2 = /*#__PURE__*/_styled.input.withConfig({
  displayName: "Input",
  ...
  var theme = _ref2.theme;
  return transparentize(1 - loadingOpacity, theme.primary);
}, function (_ref3) {
  var theme = _ref3.theme;
  return transparentize(1 - loadingOpacity, theme.primary);
});
var StringInput = /*#__PURE__*/forwardRef(function StringInput(_ref4, ref) {
  var value = _ref4.value,
      _onChange = _ref4.onChange,
      props = _objectWithoutProperties(_ref4, _excluded$1);

  return /*#__PURE__*/React.createElement(Input$2, _extends$8({
    value: value,
...
var NumericInput = /*#__PURE__*/forwardRef(function NumericInput(_ref5, ref) {
...
var IntegerInput = /*#__PURE__*/forwardRef(function IntegerInput(props, ref) {
  return /*#__PURE__*/React.createElement(NumericInput, _extends$8({
    pattern: "^[0-9]*$",
...
function TokenButton$1(_ref5) {
  ...
  }, value ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(TokenImg$1, {
    token: value,
    size: 1.2
  }), value.symbol) : /*#__PURE__*/React.createElement(Trans, {
    id: "Select a token"
...
function TokenOption$1(_ref7) {
  ...
  return /*#__PURE__*/React.createElement(TokenButton, {
    ...
    onKeyDown: onEvent,
    ref: ref
  }, /*#__PURE__*/React.createElement(Body1, null, /*#__PURE__*/React.createElement(Row, null, /*#__PURE__*/React.createElement(Row, {
    gap: 0.5
    ...
    gap: 0.125,
    align: "flex-start"
  }, /*#__PURE__*/React.createElement(Subhead1, null, value.symbol), /*#__PURE__*/React.createElement(Caption$1, {
    color: "secondary"
...
var SearchInput = /*#__PURE__*/_styled(StringInput).withConfig({
...
function TokenSelectDialog(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Dialog, {
    ...
    pad: 0.75,
    grow: true
  }, /*#__PURE__*/React.createElement(Body1, null, /*#__PURE__*/React.createElement(SearchInput, {
    value: query,
    onChange: setQuery,
    placeholder:
    /*i18n*/
...
var TokenSelect = /*#__PURE__*/memo(function TokenSelect(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(TokenButton$1, {
    ...
    disabled: disabled,
    onClick: onOpen
  }), open && /*#__PURE__*/React.createElement(TokenSelectDialog, {
    value: value,
...
var delayedFadeIn = keyframes(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["\n  0% {\n    opacity: 0;\n  }\n  25% {\n    opacity: 0;\n  }\n  100% {\n    opacity: 1;\n  }\n"])));

var MaxButton = /*#__PURE__*/_styled(Button$1).withConfig({
...
function TokenInput(_ref4) {
  ...
  return /*#__PURE__*/React.createElement(Column, {
    gap: 0.25
  }, /*#__PURE__*/React.createElement(TokenInputRow, {
    gap: 0.5,
    onBlur: onBlur
  }, /*#__PURE__*/React.createElement(H2, null, /*#__PURE__*/React.createElement(ValueInput, {
    value: amount,
    ...
    ref: input
  })), showMax && /*#__PURE__*/React.createElement(MaxButton, {
    onClick: onClickMax,
    ref: maxButton
...
function Input$1(_ref5) {
  ...
  return /*#__PURE__*/React.createElement(InputColumn, {
    gap: 0.5,
  ...
  }, usdc ? "$".concat(formatCurrencyAmount(usdc, 6, 'en', 2)) : '-'), balance && /*#__PURE__*/React.createElement(Balance, {
    color: balanceColor,
    focused: focused
  }, "Balance: ", /*#__PURE__*/React.createElement("span", null, formatCurrencyAmount(balance, 4, i18n.locale)))))), /*#__PURE__*/React.createElement(Row, null));
}
...
function ExternalLink(_ref) {
  ...
  return /*#__PURE__*/React.createElement("a", _extends$8({
    target: target,
    rel: rel,
    href: href
  }, rest), rest.children);
...
var BrandedFooter = /*#__PURE__*/memo(function BrandedFooter() {
  return /*#__PURE__*/React.createElement(Row, {
    ...
    gap: 0.25
  }, /*#__PURE__*/React.createElement(Logo, null), /*#__PURE__*/React.createElement(Caption$1, null, /*#__PURE__*/React.createElement(Trans, {
...
var OutputColumn = /*#__PURE__*/_styled(Column).withConfig({
...
function Output(_ref5) {
  ...
  return /*#__PURE__*/React.createElement(DynamicThemeProvider, {
    color: color
  }, /*#__PURE__*/React.createElement(OutputColumn, {
    hasColor: hasColor,
    gap: 0.5
  }, /*#__PURE__*/React.createElement(Row, null, /*#__PURE__*/React.createElement(Subhead1, {
    color: "secondary"
  }, /*#__PURE__*/React.createElement(Trans, {
    id: "For"
  }))), /*#__PURE__*/React.createElement(TokenInput, {
    ...
    gap: 0.5,
    isLoading: isRouteLoading
  }, outputUSDC ? "$".concat(formatCurrencyAmount(outputUSDC, 6, 'en', 2)) : '-', ' ', impact && /*#__PURE__*/React.createElement(Body2, {
    color: impact.warning
  }, "(", impact.toString(), ")")), balance && /*#__PURE__*/React.createElement(Balance, {
    focused: focused
  }, "Balance: ", /*#__PURE__*/React.createElement("span", null, formatCurrencyAmount(balance, 4, i18n.locale)))))), /*#__PURE__*/React.createElement(Rule, null), children, /*#__PURE__*/React.createElement(BrandedFooter, null)));
}

var ReverseRow = /*#__PURE__*/_styled(Row).withConfig({
...
function ReverseButton(_ref6) {
  ...
  return /*#__PURE__*/React.createElement(ReverseRow, {
    justify: "center"
  }, /*#__PURE__*/React.createElement(Overlay$1, null, /*#__PURE__*/React.createElement(StyledReverseButton, {
    disabled: disabled,
    onClick: onClick,
    turns: turns
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ArrowUp, {
    strokeWidth: 3
...
function MaxSlippageSelect() {
  ...
  var _useState = useState((maxSlippage === null || maxSlippage === void 0 ? void 0 : maxSlippage.toString()) || ''),
      _useState2 = _slicedToArray(_useState, 2),
  ...
  var _useState3 = useState(getSlippageWarning(toPercent(maxSlippage))),
      _useState4 = _slicedToArray(_useState3, 2),
  ...
  var processInput = useCallback(function (input) {
...
function TransactionTtlInput() {
  ...
  }), /*#__PURE__*/React.createElement(Body1, null, /*#__PURE__*/React.createElement(Input, {
    justify: "start",
...
function SettingsDialog() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Header$1, {
    ...
    id: "Reset"
  })))), /*#__PURE__*/React.createElement(_StyledColumn, {
    gap: 1,
    style: {
      paddingTop: '1em'
    },
    ...
    padded: true,
    $_css: scrollbar
  }, /*#__PURE__*/React.createElement(BoundaryProvider, {
    value: boundary
  }, /*#__PURE__*/React.createElement(MaxSlippageSelect, null), /*#__PURE__*/React.createElement(TransactionTtlInput, null))));
}
...
function Settings(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(SettingsButton, {
    disabled: disabled,
    hover: hover,
    onClick: function onClick() {
      return setOpen(true);
  ...
  }, /*#__PURE__*/React.createElement(SettingsDialog, null)));
}

var _StyledColumn = /*#__PURE__*/_styled(Column).withConfig({
...
var grow = keyframes(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n  from {\n    opacity: 0;\n    width: 0;\n  }\n  to {\n    opacity: 1;\n    width: max-content;\n  }\n"])));

var actionCss = css(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["\n  border: 1px solid ", ";\n  padding: calc(0.25em - 1px);\n  padding-left: calc(0.75em - 1px);\n\n  ", " {\n    animation: ", " 0.25s ease-in;\n    flex-grow: 1;\n    justify-content: flex-start;\n    white-space: nowrap;\n  }\n\n  ", " {\n    border-radius: ", "em;\n    flex-grow: 0;\n    padding: 1em;\n  }\n"])), function (_ref2) {
  var theme = _ref2.theme;
  return theme.outline;
...
function EtherscanLink(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(StyledExternalLink, {
    ...
    gap: 0.25
  }, children, url && /*#__PURE__*/React.createElement(Link, null)));
}
...
function Price(_ref) {
  ...
  return /*#__PURE__*/React.createElement(TextButton, {
    ...
    sigFigs: 1,
    locale: i18n.locale
  }), " ", price.baseCurrency.symbol, " =", ' ', formatPrice(price, 6, i18n.locale), " ", price.quoteCurrency.symbol, usdcPrice && /*#__PURE__*/React.createElement(Caption$1, {
    color: "secondary"
...
function TokenValue(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Column, {
    ...
    userSelect: true
  }, formatCurrencyAmount(input, 6, i18n.locale), " ", input.currency.symbol)), usdc && /*#__PURE__*/React.createElement(Caption$1, {
    color: "secondary",
    userSelect: true
  }, /*#__PURE__*/React.createElement(Row, {
    justify: "flex-start",
...
function Summary(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(Row, {
    gap: impact ? 1 : 0.25
  }, /*#__PURE__*/React.createElement(TokenValue, {
    input: input,
    usdc: inputUSDC
  }), /*#__PURE__*/React.createElement(ArrowRight, null), /*#__PURE__*/React.createElement(TokenValue, {
    input: output,
    usdc: outputUSDC
...
var TransactionRow = /*#__PURE__*/_styled(Row).withConfig({
...
function ElapsedTime(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Row, {
    gap: 0.5
  }, /*#__PURE__*/React.createElement(Clock, null), /*#__PURE__*/React.createElement(Body2, null, toElapsedTime(elapsedMs)));
}
...
function TransactionStatus(_ref2) {
  ...
  var heading = useMemo(function () {
    ...
    if (tx.info.type === TransactionType.SWAP) {
      ...
      if (tx.info.unwrapped) {
        ...
        return (_tx$receipt4 = tx.receipt) !== null && _tx$receipt4 !== void 0 && _tx$receipt4.status ? /*#__PURE__*/React.createElement(Trans, {
          id: "Unwrap confirmed"
        }) : /*#__PURE__*/React.createElement(Trans, {
          id: "Unwrap pending"
        });
      ...
      return (_tx$receipt5 = tx.receipt) !== null && _tx$receipt5 !== void 0 && _tx$receipt5.status ? /*#__PURE__*/React.createElement(Trans, {
        id: "Wrap confirmed"
      }) : /*#__PURE__*/React.createElement(Trans, {
        id: "Wrap pending"
      });
    ...
    return (_tx$receipt6 = tx.receipt) !== null && _tx$receipt6 !== void 0 && _tx$receipt6.status ? /*#__PURE__*/React.createElement(Trans, {
  ...
  }, /*#__PURE__*/React.createElement(Subhead1, null, heading), tx.info.type === TransactionType.SWAP ? /*#__PURE__*/React.createElement(Summary, {
    input: tx.info.inputCurrencyAmount,
    output: tx.info.outputCurrencyAmount
  }) : null), /*#__PURE__*/React.createElement(Rule, null), /*#__PURE__*/React.createElement(TransactionRow, {
    flex: true
  }, /*#__PURE__*/React.createElement(ButtonSmall, null, /*#__PURE__*/React.createElement(EtherscanLink, {
...
function TransactionStatusDialog(_ref3) {
  ...
  return ((_tx$receipt9 = tx.receipt) === null || _tx$receipt9 === void 0 ? void 0 : _tx$receipt9.status) === 0 ? /*#__PURE__*/React.createElement(ErrorDialog, {
...
function Header(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Row, {
    ...
    gap: 0.25
  }, /*#__PURE__*/React.createElement(AutoRouter, null), /*#__PURE__*/React.createElement(StyledAutoRouterLabel, {
    color: "primary",
    lineHeight: '16px'
  }, /*#__PURE__*/React.createElement(Trans, {
    id: "Auto Router"
  })))), /*#__PURE__*/React.createElement(Body2, null, /*#__PURE__*/React.createElement(Trans, {
...
function RouteDetail(_ref7) {
  ...
  return /*#__PURE__*/React.createElement(RouteNode, null, /*#__PURE__*/React.createElement(Row, {
    gap: 0.375
  }, /*#__PURE__*/React.createElement(Caption$1, null, route.percent.toSignificant(2), "%"), /*#__PURE__*/React.createElement(RouteBadge, null, /*#__PURE__*/React.createElement(Badge, {
    color: "secondary"
  }, protocol))));
}
...
function Pool(_ref8) {
  ...
  return /*#__PURE__*/React.createElement(RoutePool, null, /*#__PURE__*/React.createElement(Caption$1, null, /*#__PURE__*/React.createElement(Row, {
    gap: 0.25
  }, /*#__PURE__*/React.createElement(TokenImg$1, {
...
function Route(_ref9) {
  ...
  }, /*#__PURE__*/React.createElement(Dots, null), /*#__PURE__*/React.createElement(RouteDetail, {
    route: route
  }), /*#__PURE__*/React.createElement(RouteRow, {
...
function RoutingDiagram(_ref12) {
  ...
  return /*#__PURE__*/React.createElement(Column, {
    ...
    routes: routes
  }), /*#__PURE__*/React.createElement(Rule, null), routes.map(function (route, index) {
...
function Trade(_ref5) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Tooltip, {
    ...
    gap: 0.75
  }, (impact === null || impact === void 0 ? void 0 : impact.warning) && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Caption$1, null, "The output amount is estimated at ", impact.toString(), " less than the input amount due to high price impact"), /*#__PURE__*/React.createElement(Rule, null)), /*#__PURE__*/React.createElement(RoutingDiagram, {
    trade: trade
...
var Toolbar = /*#__PURE__*/memo(function Toolbar() {
  var _useActiveWeb3React = useActiveWeb3React(),
  ...
  var caption = useMemo(function () {
    if (!active || !chainId) {
      if (activating) return /*#__PURE__*/React.createElement(Connecting, null);
      return /*#__PURE__*/React.createElement(ConnectWallet, null);
    }

    if (!ALL_SUPPORTED_CHAIN_IDS.includes(chainId)) {
      return /*#__PURE__*/React.createElement(UnsupportedNetwork, null);
    }

    if (inputCurrency && outputCurrency && isAmountPopulated) {
      if (state === TradeState.SYNCING || state === TradeState.LOADING) {
        return /*#__PURE__*/React.createElement(LoadingTrade, null);
      }

      if (inputBalance && inputAmount !== null && inputAmount !== void 0 && inputAmount.greaterThan(inputBalance)) {
        return /*#__PURE__*/React.createElement(InsufficientBalance, {
          currency: inputCurrency
        });
      }

      if (wrapType !== WrapType.NONE) {
        return /*#__PURE__*/React.createElement(WrapCurrency, {
      ...
      if (state === TradeState.NO_ROUTE_FOUND || trade && !trade.swaps) {
        return /*#__PURE__*/React.createElement(InsufficientLiquidity, null);
      }

      if (trade !== null && trade !== void 0 && trade.inputAmount && trade.outputAmount) {
        return /*#__PURE__*/React.createElement(Trade, {
          trade: trade,
          outputUSDC: outputUSDC,
          impact: impact
        });
  ...
  return /*#__PURE__*/React.createElement(Caption$1, {
    "data-testid": "toolbar"
  }, /*#__PURE__*/React.createElement(ToolbarRow, {
    justify: "flex-start",
    gap: 0.5,
    iconSize: 4 / 3
  }, caption));
...
function Swap(props) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Header$2, {
    ...
    value: wrapper
  }, /*#__PURE__*/React.createElement(SwapInfoProvider, {
    disabled: isDisabled
  }, /*#__PURE__*/React.createElement(Input$1, {
    disabled: isDisabled,
    focused: focused,
    onChange: props.onChange
  }), /*#__PURE__*/React.createElement(ReverseButton, {
    disabled: isDisabled
  }), /*#__PURE__*/React.createElement(Output, {
    disabled: isDisabled,
    focused: focused,
    onChange: props.onChange
  }, /*#__PURE__*/React.createElement(Toolbar, null))))), displayTx && /*#__PURE__*/React.createElement(Dialog, {
    color: "dialog"
...
var WidgetWrapper = /*#__PURE__*/_styled.div.withConfig({
...
function Widget(props) {
  ...
  var locale = useMemo(function () {
    ...
    if (props.locale && ![].concat(_toConsumableArray(SUPPORTED_LOCALES), ['pseudo']).includes(props.locale)) {
  ...
  return /*#__PURE__*/React.createElement(StrictMode, null, /*#__PURE__*/React.createElement(ThemeProvider, {
    theme: theme
...
export { DEFAULT_LOCALE, SUPPORTED_LOCALES, SupportedChainId, SwapWidget, darkTheme, defaultTheme, lightTheme };
